 ...
 * @author kyu
 */
public class CashierTest4 extends TestCase
{
	...
	public void setUp() throws Exception{
		...
		customer = new MockCustomer("mockcustomer.thief");		
	...
	public void testOneNormalCustomerScenario()
	{
		...
		assertTrue("Cashier should have logged \"Received msgPayment - earn 0\" but didn't. His log reads instead: " 
				+ cashier.log.getLastLoggedEvent().toString(), cashier.log.containsString("Received msgPayment - earn 0"));
