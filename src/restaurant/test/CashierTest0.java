 ...
 * @author kyu
 */
public class CashierTest0 extends TestCase
{
	...
	public void testOneNormalCustomerScenario()
	{
		...
		customer.cash = new Cash(0,1,0,0,0);
		...
		assertTrue("Cashier should have logged \"Received msgPayment - earn full\" but didn't. His log reads instead: " 
				+ cashier.log.getLastLoggedEvent().toString(), cashier.log.containsString("Received msgPayment - earn full"));
